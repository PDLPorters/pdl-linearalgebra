...
runtest($x, 'mschur', pdl([0.36637354,-0.72],[0,0.78362646]), [1,1,1,undef]);
runtest($x, 'mschur', pdl([0.36637354,-0.72],[0,0.78362646]), [2,2,2,sub {1},0]);
runtest($x, 'mschur', pdl([0.36637354,-0.72],[0,0.78362646]), [2,2,2,sub {1},0,0]);
...
runtest($a, 'mschurx', [pdl([-1.605735,-6],[0,10.605735]),pdl([-1.605735,6],[0,10.605735])], [1,1,1,sub {1}]);
runtest($a, 'mschurx', [pdl([-1.605735,-6],[0,10.605735]),pdl([-1.605735,6],[0,10.605735])], [2,2,2,sub {1},0,0]);
runtest($a, 'mschurx', [pdl([-1.605735,-6],[0,10.605735]),pdl([-1.605735,6],[0,10.605735])], [2,2,2,undef,0,0]);
...
runtest($x, 'mgsvd', pdl(0.16914549,0.64159379), [sequence(2,2), opt=>'all']);
