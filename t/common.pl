...
runtest(sequence(3,3), 'msymgeigenx', $x_symgeigen->dummy(1,1), [$posdef]);
runtest(sequence(3,3), 'msymgeigenx', $x_symgeigen->dummy(1,1), [$posdef,0,1]);
...
runtest($x, 'msymeigenx', $x_symeigen->dummy(1,1));
runtest($x, 'msymeigenx', $x_symeigen->dummy(1,1), [0,1]);
runtest($x, 'msymeigenx', pdl(-0.188888,1.338888)->dummy(1,1), [1]);
